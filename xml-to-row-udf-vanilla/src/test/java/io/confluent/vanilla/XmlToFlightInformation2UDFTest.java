...
import io.confluent.ek.vanilla.XmlToFlightInformation2UDF;
...
//        if(flightinformation.getField(0) != null) throw new RuntimeException("Error found");
    ...
    @Test
    void should_parse()  {
        Row flightinformation = new XmlToFlightInformation2UDF().eval("<flight><flight_number>FL123</flight_number><carrier>EK</carrier><departure_timestamp>1703126400</departure_timestamp><origin>OMDB</origin><destination>EGLL</destination><passengers><passenger><reference>REF1019</reference><name>Ava Singh</name><date_of_birth>1974-10-21</date_of_birth><passport_number>EP86016</passport_number><seat_number>39A</seat_number><class>premium</class><deleted>true</deleted></passenger><passenger><reference>REF1020</reference><name>Ethan Wang</name><date_of_birth>1990-07-07</date_of_birth><passport_number>EP86016</passport_number><seat_number>40B</seat_number><class>economy</class><deleted>true</deleted></passenger></passengers></flight>".getBytes());
        System.out.println("flightinformation = " + flightinformation);
        if (flightinformation.getField(1) == null) throw new NullPointerException();
    }
}